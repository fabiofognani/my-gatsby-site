...
export interface IAnotherTestContentFields {
  /** Name */
...
export interface IAnotherTestContent extends Entry<IAnotherTestContentFields> {
  sys: {
    id: string;
    type: string;
    createdAt: string;
...
export interface IFakePostFields {
  /** Title */
